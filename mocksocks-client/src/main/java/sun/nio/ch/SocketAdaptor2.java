...
public class SocketAdaptor2
    extends Socket
{

    // The channel being adapted
    private final SocketChannelImpl2 sc;

    // Option adaptor object, created on demand
    private volatile OptionAdaptor2 opts = null;
    ...
    private SocketAdaptor2(SocketChannelImpl2 sc) {
        this.sc = sc;
    }

    public static Socket create(SocketChannelImpl2 sc) {
        return new SocketAdaptor2(sc);
    }
    ...
    private OptionAdaptor2 opts() {
        if (opts == null)
            opts = new OptionAdaptor2(sc);
        return opts;
    }
