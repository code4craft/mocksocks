...
class OptionAdaptor2 {                                   // package-private

    private final SocketOpts.IP opts;

    OptionAdaptor2(SocketChannelImpl2 sc) {
        opts = (SocketOpts.IP)sc.options();
    }

    OptionAdaptor2(ServerSocketChannelImpl ssc) {
        opts = (SocketOpts.IP)ssc.options();
    }

    OptionAdaptor2(DatagramChannelImpl dc) {
