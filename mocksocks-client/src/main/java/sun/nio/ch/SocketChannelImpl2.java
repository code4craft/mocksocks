    ...
    implements SelChImpl
{
    ...
    //
    SocketChannelImpl2(SelectorProvider sp) throws IOException {
        super(sp);
    ...
    //
    SocketChannelImpl2(SelectorProvider sp,
    ...
    public Socket socket() {
        synchronized (stateLock) {
            if (socket == null)
                socket = SocketAdaptor2.create(this);
            return socket;
        }
    }
